...
//		BasePath: /
//		Version: 1.0.0
//		Contact: Daniel Mbazu <mbazudaniel97@gmail.com> https://teamlyf.vercel.app
//
//		Consumes:
//		- application/json
//
...
func ListRecipesHandler(c *gin.Context) {
	if collection == nil {
		c.JSON(http.StatusInternalServerError, gin.H{
			"error": "Database collection is not initialized",
		})
		return
	}
...
func init() {
	...
	if mongoURI == "" || mongoDatabase == "" || mongoCollection == "" {
		log.Fatal("MONGO_URI or MONGO_DATABASE environment variable is not set")
	}
